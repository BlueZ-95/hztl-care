            ...
            <div className="">
              <div className="-5">
                ...
                <input
                  ...
                  type="text"
                  {...register("name")}
                  className={`appearance-none bg-transparent border-b-4 w-full py-1.5 focus:outline-none ${errors.name ? "is-invalid border-theme-01"
                              : "border-theme-bg"}`}
                />
                <div className="invalid-feedback text-theme-01 absolute">{errors.name?.message}</div>
              </div>
              <br />
            </div>
            <div className="">
              <div className="">
                ...
                <input
                  ...
                  type="text"
                  {...register("email")}
                  className={`appearance-none bg-transparent border-b-4 w-full py-1.5 focus:outline-none ${errors.email ? "is-invalid border-theme-01"
                              : "border-theme-bg"}`}
                />
                <div className="invalid-feedback text-theme-01 absolute">{errors.email?.message}</div>
              </div>
              <br />
            </div>
            <div className="">
              <div className="">
                ...
                <input
                  ...
                  className={`appearance-none bg-transparent border-b-4 w-full py-1.5 focus:outline-none ${
                    errors.password ? "is-invalid border-theme-01"
                              : "border-theme-bg"
                  }`}
                />
              ...
              <div className="">
                ...
                <input
                  ...
                  className={`appearance-none bg-transparent border-b-4 w-full py-1.5 focus:outline-none ${
                    errors.confirmPassword ? "is-invalid border-theme-01"
                              : "border-theme-bg"
                  }`}
                />
                <div className="invalid-feedback text-theme-01 absolute">
